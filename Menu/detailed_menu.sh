...
source "$PROJECT_ROOT/Tools/ssh_protocol.sh"
source "$PROJECT_ROOT/Tools/remote_shell_administration.sh"
source "$PROJECT_ROOT/Tools/Cryptography/authentication.sh"
source "$PROJECT_ROOT/Tools/Cryptography/key_generation.sh"
source "$PROJECT_ROOT/Tools/Cryptography/access_control.sh"
source "$PROJECT_ROOT/Tools/Cryptography/choosing-symmetric-algorithms.sh"
source "$PROJECT_ROOT/Tools/System-Hardening/hardening-compilation.sh"
source "$PROJECT_ROOT/Tools/System-Hardening/privilege_separation.sh"
source "$PROJECT_ROOT/Tools/System-Hardening/sftp-chroot.sh"
source "$PROJECT_ROOT/Tools/Authentication-Access-Control/user_auth.sh"
source "$PROJECT_ROOT/Tools/Authentication-Access-Control/agent_auth.sh"
source "$PROJECT_ROOT/Tools/Authentication-Access-Control/access_accountability.sh"
source "$PROJECT_ROOT/Tools/Authentication-Access-Control/allow-users.sh"
source "$PROJECT_ROOT/Tools/Authentication-Access-Control/restrictions_of_the_user_environment.sh"
source "$PROJECT_ROOT/Tools/Protocole-Network-Access/listen-address-port.sh"
source "$PROJECT_ROOT/Tools/Protocole-Network-Access/tcp-forwarding.sh"
source "$PROJECT_ROOT/Tools/Protocole-Network-Access/x11-forwarding.sh"
source "$PROJECT_ROOT/Tools/OpenSSH-PKI/revocation.sh"
source "$PROJECT_ROOT/Tools/DNS-Record/dns-record.sh"
